...
<p class="margin-btm-44">
  ...
  at scale; without compromising on the developer experience and design standards of CloudCover.
</p>
...
<p class="margin-btm-24">
  ...
  framework. This includes naming conventions, props and values definitions, documentation, etc.
</p>
