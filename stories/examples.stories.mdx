    ...
    args={{
      ...
      ["node-template"]: function (node) {
        ...
        >
          <f-div height="hug-content">
            <f-text variant="heading" size="medium"
              >${node.fData.designation}</f-text
            >
            ${node.childrenToggle}
          </f-div>
          <f-div height="hug-content" gap="small">
            ...
            <f-div direction="column" height="hug-content" align="middle-left">
              ...
              <f-div padding="x-small none none none">
                <f-text size="small" ellipsis
                  >Mobile No : ${node.fData.mobile}</f-text
                >
              </f-div>
              <f-div padding="x-small none none none">
                <f-text size="small" ellipsis
                  >Email : ${node.fData.email}</f-text
                >
              </f-div>
            </f-div>
          </f-div>
      ...
      ["children-node-template"]: function (node) {
        ...
        >
          ...
          <f-text variant="code" size="medium" ellipsis
            >${node.fData.fullName}</f-text
          >
        </f-div>`;
      },
    }}
