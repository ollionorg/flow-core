...
import fCounterAnatomy from "./svg/f-counter-anatomy.js";
import { unsafeSVG } from "lit-html/directives/unsafe-svg.js";

<Meta title="Components/f-counter" />

<h1 class="margin-btm-36">f-counter</h1>
<h4 class="margin-btm-8">Overview</h4>
<hr class="margin-btm-24" />
<p class="margin-btm-24">A counter is a visual indicator for numeric values.</p>
