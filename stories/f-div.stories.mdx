...
<div class="margin-btm-24">
  ...
  <ul>
    <li>
      <p>Fill container: width is set to the parent container’s width.</p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>Fixed: width is set to the numerical value passed to the width property.</p>
    </li>
  </ul>
</div>
...
<div class="margin-btm-24">
  ...
  <ul>
    <li>
      <p>Fill container: height is set to the parent container’s height.</p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>Fixed: width is set to the numerical value passed to the height property.</p>
    </li>
  </ul>
</div>
...
<div class="margin-btm-24">
  ...
  <ul>
    ...
    <li>
      <p>Hidden: Overflowing elements are clipped and remain hidden.</p>
    </li>
  </ul>
</div>
