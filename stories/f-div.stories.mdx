  ...
  <Story name="sticky">
    {(args) => html`<f-div gap="medium" padding="large" direction="column">
      ...
      <f-div
        ...
        overflow="scroll"
      >
        <f-div width="300px" height="hug-content" padding="x-large" state="secondary" sticky="top">
      ...
      <f-div
        ...
        overflow="scroll"
      >
        <f-div width="300px" height="hug-content" padding="x-large" state="secondary" sticky="left">
  ...
  <Story name="loading">
    {(args) => html`<f-div gap="medium" padding="x-large" direction="row">
      ...
      <f-div padding="none" direction="column" align="middle-center" gap="large">
        ...
        <f-div padding="small" state="subtle" width="200px" loading="skeleton" align="middle-center"
          ><f-text variant="para" size="medium" weight="regular">loader</f-text></f-div
        >
      </f-div>
    </f-div>`}
