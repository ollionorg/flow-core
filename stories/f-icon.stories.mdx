  ...
  >
    ...
    >
      ...
      <f-icon
        ...
        id="deleteTarget"
      ></f-icon>
      <f-tooltip placement="bottom" target="#deleteTarget"
        ><f-div state="custom,black" padding="small medium">
          <f-div direction="column">
            <f-text variant="para" size="small"> Hello Everyone </f-text>
            <f-text variant="para" size="small" state="primary">
              Learn More
            </f-text>
          </f-div>
        </f-div></f-tooltip
  ...
  <Story name="size">
    {(args) => html`<f-div gap="medium" padding="x-large" align="middle-center">
      <f-div padding="large" gap="medium" direction="column" width="hug-content">
        ...
        <f-div height="hug-content" padding="none" align="middle-center">
          <f-icon tooltip="Test" source="i-plus" size="x-large"></f-icon>
        </f-div>
      </f-div>
      <f-div padding="large" gap="medium" direction="column" width="hug-content">
        <f-div height="hug-content" padding="none" align="middle-center">
