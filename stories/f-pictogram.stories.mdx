...
import fPictogramAnatomy from "./svg/f-pictogram-anatomy.js";
import { unsafeSVG } from "lit-html/directives/unsafe-svg.js";

<Meta title="Components/f-pictogram" />

<h1 class="margin-btm-36">f-pictogram</h1>
...
<hr class="margin-btm-24" />
<p class="margin-btm-24">The large size is the default.</p>
