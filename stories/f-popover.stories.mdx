          ...
          >
            <f-div state="tertiary" padding="medium">
              <f-text>
                ...
                Phasellus imperdiet enim ut mi egestas, non efficitur odio
                varius. Phasellus accumsan pellentesque ex vehicula tristique.
              </f-text>
            </f-div>
          </f-popover>
          <f-icon source="p-aws" size="large"></f-icon>
          <f-button id="popoverTarget" label="Open" @click=${handlePopover}>
          </f-button>
        </f-div>
      `;
    }}
  ...
  >
    {(args) => {
      ...
      const handlePopover = (main_index, index) => {
        ...
        array[index][main_index].open =
          !dummyPlacementArray[index][main_index].open;
                    ...
                    >
                      <f-div state="tertiary" padding="medium">
                        <f-text>
                          ...
                          elit. Phasellus imperdiet enim ut mi egestas, non
                          efficitur odio varius. Phasellus accumsan pellentesque
                          ex vehicula tristique.
                        </f-text>
                      </f-div>
                    </f-popover>
                    <f-button
...
<table class="custom-table">
  <tbody>
    ...
    <tr>
      <td>auto</td>
      <td>
        Sets the placement of popover automatically according to the screen size
      </td>
      <td>
        <code>default</code>
      </td>
    ...
    <tr>
      <td>right-start</td>
      <td>
        starting from top to downwards on right side wrt to the button opening
        popup
      </td>
      <td></td>
    </tr>
    <tr>
      <td>right-end</td>
      <td>
        starting from bottom to upwards on right side wrt to the button opening
        popup
      </td>
      <td></td>
    </tr>
    ...
    <tr>
      <td>left-start</td>
      <td>
        starting from top to downwards on left side wrt to the button opening
        popup
      </td>
      <td></td>
    </tr>
    <tr>
      <td>left-end</td>
      <td>
        starting from bottom to upwards on left side wrt to the button opening
        popup
      </td>
      <td></td>
    </tr>
...
<br />
Each size defines a width and a maximum height. By default the height will adjust
to the content of the popover and if the max height is attained, the body contents
will scroll.
...
<table class="custom-table">
  <tbody>
    ...
    <tr>
      <td>stretch</td>
      <td>
        Viewport width with a 16px gutter/padding and Viewport height with a
        16px gutter/padding
      </td>
      <td></td>
    </tr>
      ...
      return html` <f-div height="hug-content" gap="large" direction="column">
        ...
        <f-div height="hug-content" gap="large" direction="row">
          ...
          <f-popover
            ...
            @overlay-click=${() =>
              setOpenFlagForNoOverlay(!openFlagForNoOverlay)}
          >
            <f-div state="tertiary" padding="medium">
              <f-text>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
<table class="custom-table">
  <tbody>
    ...
    <tr>
      <td>overlay</td>
      <td>
        If we need black with 50% opacity background ot not when open the
        popover
      </td>
      <td>
        <code>true</code>
