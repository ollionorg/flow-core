...
export const Playground = {
	render: args => html` <f-div padding="large">
		<f-tag
			.label=${args.label}
			.size=${args.size}
			.state=${args.state}
...
export const Size = {
	render: args => html`<f-div gap="x-large" padding="x-large" align="middle-center">
...
export const State = {
	render: args => html`<f-div gap="x-large" padding="x-large" align="middle-center" state="primary">
...
export const Label = {
	render: args => html`<f-div gap="large" padding="x-large" direction="row" align="middle-center">
...
export const IconLeft = {
	render: args => html`<f-div gap="large" padding="x-large" align="middle-center" direction="row">
