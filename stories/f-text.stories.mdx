    ...
    {(args) => html`
      <f-div padding="none">
        <f-text
          ...
          >This is ${args.variant} with ${args.size} and "${args.state}" state. Alignment
          is ${args.align}</f-text
        ></f-div
      >
    `}
  </Story>
  ...
  <Story name="size">
    {(args) => html`<f-div gap="medium" padding="x-large" direction="column">
      ...
      <f-div gap="medium" padding="medium" align="middle-center">
        ...
        <f-div height="hug-content" padding="none" align="middle-center">
          <f-text variant="heading" size="x-small" weight="medium"
            >x-small</f-text
          >
        </f-div>
      </f-div>
      <f-text variant="para" size="large" weight="medium"
        >size of variant="para"</f-text
      >
      <f-divider></f-divider>
      <f-div gap="medium" padding="medium" align="middle-center">
        <f-div height="hug-content" padding="none" align="middle-center">
...
<Canvas>
  <Story name="align">
    {(args) => html`
      <br />
      <f-text variant="para" size="large" weight="medium" align="left"
  ...
  <Story name="Flags">
    {(args) => html`<f-div gap="large" padding="x-large" direction="column">
      ...
      >
        ...
        <f-div width="hug-content" padding="none">
          <f-text variant="para" weight="regular" loading=${true}
            >Loading</f-text
          >
        </f-div>
      </f-div>
      ...
      >
        ...
        <f-div width="hug-content" padding="none">
          <f-text variant="para" weight="regular" disabled=${true}
            >Disabled</f-text
          >
        </f-div>
      </f-div>
...
<table class="custom-table">
  <tbody>
    ...
    <tr>
      <td>ellipsis</td>
      <td>
        By default no. of rows is to 1. Ellipsis will crop the text after one
        line w.r.t the outer div
      </td>
      <td>false</td>
    </tr>
  </tbody>
