...
<Meta title="@ollion/flow-form-builder/About" />
...
```
pnpm i --save @ollion/flow-form-builder
```
...
```
<style>
	@import "@ollion/flow-form-builder/dist/style.css";
</style>
```
...
```
"styles": ["@ollion/flow-form-builder/dist/style.css"],
```
